...
public class StudentService {
    ...
    public String enrollStudentToExam(int studentId, int examId){
        ...
        postgresRepository.runQuery("INSERT INTO STUDENT_EXAMS(id_student, id_exam) values (" + studentId + ", " + examId +");");
        return "Success";
    }
    ...
    public String insertStudent(Student student){
        ...
        postgresRepository.runQuery("Insert into students(id, name) values (" + (this.getNumberOfRows() + 1) + ", '" + student.getName() + "');");
        return "Success";
    }
