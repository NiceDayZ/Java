...
//    }
    ...
    public int getExamIdByName(String name){
        ResultSet resultSet = postgresRepository.runQuery("SELECT * from exams WHERE name=\'" + name + "\';");
    ...
    public String insertExam(Exam exam){
        ...
        postgresRepository.updateQuery("INSERT into exams(id, name, hour, duration) values ("
